...
describe("<Sell />", () => {
  ...
  it("updates state on change events", async () => {
    ...
    wrapper
      .find('#title')
      .simulate('change', {target: {name: 'title', value: 'A new Item Title'} });
    wrapper
      .find('#price')
      .simulate('change', {target: {name: 'price', value: 5012, type: 'number'} });
    wrapper
      .find('#description')
      .simulate('change', {target: {name: 'description', value: 'a new item description!!!!'} });
